...
namespace RippleTrade_DB
{
	...
	public partial class Path : ActiveRecord<Path>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Paths", TableType.Table, DataService.GetInstance("RippleTrade"));
				...
				DataService.Providers["RippleTrade"].AddSchema("Paths",schema);
			}
		}
		#endregion
