...
namespace RippleTrade_DB
{
	...
	public partial class PathRoute : ActiveRecord<PathRoute>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Path_Routes", TableType.Table, DataService.GetInstance("RippleTrade"));
				...
				DataService.Providers["RippleTrade"].AddSchema("Path_Routes",schema);
			}
		}
		#endregion
