...
namespace Bitcoin_Notify_DB
{
    ...
    public partial class MarketDatumController
    {
	    ...
	    public void Insert(decimal? Price,DateTime Datechanged,int MarketKey,decimal? Volume,int? Level)
	    {
	    ...
	    public void Update(decimal? Price,DateTime Datechanged,int MarketKey,decimal? Volume,int? Level)
	    {
		    MarketDatum item = new MarketDatum();
	        item.MarkOld();
	        item.IsLoaded = true;
