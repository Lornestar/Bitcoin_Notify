...
namespace Bitcoin_Notify_DB
{
	...
	public partial class ExchangeCurrency : ActiveRecord<ExchangeCurrency>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Exchange_Currency", TableType.Table, DataService.GetInstance("Bitcoin_Notify"));
				...
				DataService.Providers["Bitcoin_Notify"].AddSchema("Exchange_Currency",schema);
			}
		}
		#endregion
