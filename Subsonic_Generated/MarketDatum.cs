...
namespace Bitcoin_Notify_DB
{
	...
	public partial class MarketDatum : ActiveRecord<MarketDatum>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MarketData", TableType.Table, DataService.GetInstance("Bitcoin_Notify"));
				...
				DataService.Providers["Bitcoin_Notify"].AddSchema("MarketData",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(decimal? varPrice,DateTime varDatechanged,int varMarketKey,decimal? varVolume,int? varLevel)
		{
		...
		/// </summary>
		public static void Update(decimal? varPrice,DateTime varDatechanged,int varMarketKey,decimal? varVolume,int? varLevel)
		{
			MarketDatum item = new MarketDatum();
